...
\
  ...
  # Create instance: zybo_axis_xor_accel_0, and set properties
  set block_name zybo_axis_xor_accel
  set block_cell_name zybo_axis_xor_accel_0
  if { [catch {set zybo_axis_xor_accel_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $zybo_axis_xor_accel_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins zybo_axis_xor_accel_0/s_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net zybo_axis_xor_accel_0_m_axis [get_bd_intf_pins zybo_axis_xor_accel_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  [get_bd_pins zybo_axis_xor_accel_0/axis_aresetn]
  ...
  [get_bd_pins zybo_axis_xor_accel_0/axis_aclk]
