...
/*
 * Representative payload sizes for AXI-Stream accelerator validation.
 *
 * These sizes span small control-like buffers, moderate payloads, and the
 * current maximum transfer policy exposed by the DMA driver.
 */
 ...
 * driver behavior that must be corrected before benchmark results are useful.
 */
...
/*
 * Run the broad XOR accelerator validation suite.
 *
