 ...
 *
 * Sweep mode uses the fixed PT2 benchmark table above. Single mode exists for
...
static void print_usage(const char *program)
{
	...
	printf("\n");
	printf("modes:\n");
	printf("  --sweep              run the standard PT2 benchmark sweep\n");
...
/*
 * The current PT2 validation accelerator XORs every payload byte with 0xA5.
 ...
 * results can be reviewed or plotted later without parsing terminal tables.
 */
